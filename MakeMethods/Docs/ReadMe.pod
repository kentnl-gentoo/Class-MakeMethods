...
Class::MakeMethods::Docs::ReadMe - About Class::MakeMethods 1.007


=head1 DESCRIPTION

This is an updated release of Class::MakeMethods, for distribution
through CPAN. This release includes the Class::MakeMethods::Template
and Class::MakeMethods::Emulator modules which were previously
...
L<Class::MakeMethods> is a good starting place. Plain-text versions
of some kew documentation are also available in the docs/ directory.
